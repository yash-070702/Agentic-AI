# Exercise 1: Loading a Text File with TextLoader

# You are asked to create a pipeline to load a plain text file into LangChain for processing.

# Steps:

# Create a text file named Quantumcomputing.txt  with 3–4 lines of content (e.g., “Artificial Intelligence is transforming industries…”).

# Use LangChain’s TextLoader to load the file.

# Print the document’s metadata and content.

# Verify that the document is loaded correctly.

# Goal: Learn how to use basic file loaders in LangChain.
